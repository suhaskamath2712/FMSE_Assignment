//In this model, we have a network that can duplicate messages
//Duplication is done by non-deterministically sending the same
//message multiple times to the same replica
...
proctype Network() {
    ...
    :: r1_to_network?optype, op_ts ->
        ...
        :: network_to_r2!optype, op_ts; network_to_r2!optype, op_ts;
        fi;

        if 
        :: network_to_r3!optype, op_ts;
        :: network_to_r3!optype, op_ts; network_to_r3!optype, op_ts;
        fi;

    :: r2_to_network?optype, op_ts -> 
        if 
        :: network_to_r1!optype, op_ts;
        :: network_to_r1!optype, op_ts; network_to_r1!optype, op_ts;
        fi;
